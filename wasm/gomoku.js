...
* @returns {number}
*/
__exports.think_and_move = function(ms, tl) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.think_and_move(retptr, addHeapObject(ms), tl);
...
* @returns {number}
*/
__exports.make_move = function(r, f) {
    const ret = wasm.make_move(r, f);
    return ret;
};
...
* @returns {number}
*/
__exports.rank_of = function(m) {
    const ret = wasm.rank_of(m);
    return ret;
};
...
* @returns {number}
*/
__exports.file_of = function(m) {
    const ret = wasm.file_of(m);
    return ret;
};
...
function getImports() {
    ...
    imports.wbg.__wbg_static_accessor_performance_5c1ea95ee24deeb9 = function() {
...
function initMemory(imports, maybe_memory) {
    imports.wbg.memory = maybe_memory || new WebAssembly.Memory({initial:154,maximum:16384,shared:true});
}
